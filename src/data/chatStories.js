...
export const CHAT_STORIES = [
  ...
  {
    id: "p7",
    title: "P.7 アスクレピオスへの医学教育",
    emoji: "🌿",
    linkedStep: 3,
    messages: [
      { type: "narr", text: "ケイロンはアスクレピオスに薬草や怪我の治療法を教えた" },
      { type: "msg", char: "chiron", text: "よいかアスクレピオス。子供たちがレスリングなどの運動競技を日課としており、生傷の絶える日はなかった。" },
      { type: "msg", char: "student", text: "それでアスクレピオスはどうなったんですか？" },
      { type: "msg", char: "chiron", text: "ある日、擦り傷を作ってきた。「相手が大きく三人だったので負けた」と言い訳をした。" },
      { type: "msg", char: "chiron", text: "私は怒って言った。『アポロン様の御子が負けてどうする！今一度戦いに戻れ！』" },
      { type: "msg", char: "chiron", text: "手当が遅れて炎症が悪化した場合にはアルゲモニアを貼ったものだ。" },
      { type: "highlight", text: "💡 昔は薬を水に溶くときに「薬指」を使っていた。一番綺麗で清らかとされた指だからだ。また、医師が薬の調合を指示するものを「処方」という。" },
      { type: "choice", text: "昔、薬を溶かすのに使われた指は？", options: ["親指", "中指", "薬指"], answer: 2 },
      { type: "narr", text: "ケイロンはさらに深い「医術の真理」を教える" },
      { type: "msg", char: "chiron", text: "医術とは、生に奉仕する術だ。決して生死そのものを決めてはならない。" },
      { type: "msg", char: "chiron", text: "『人間とはどこから来たのか、人間とはどこへ行くのか』を考えることが人生の最大の意義だ。" },
      { type: "msg", char: "chiron", text: "正解のあるものではないが、一生をかけて考え続けるのだ。" },
      { type: "highlight", text: "🌿 ケイロンの教え：医術は生き様に奉仕する業であり、生死そのものを操作してはならない。" },
    ],
  },
  ...
  {
    id: "p8",
    title: "P.8 アスクレピオスの生涯",
    emoji: "⚕️",
    linkedStep: 3,
    messages: [
      { type: "narr", text: "成長したアスクレピオスは独立し、エピダウロスにアスクレピエイオンという神殿（世界最初の病院）を建てた" },
      { type: "msg", char: "asclepius", text: "ここには待合室と宿泊施設がある。信仰と治療が同時に行われる聖域だ。" },
      { type: "highlight", text: "🏥 アスクレピエイオンは世界最初の病院と言われている。人々はここで宿泊し奇跡の治療を待った。" },
      { type: "narr", text: "ある日、患者が薬の副作用でショック死してしまう事件が起きた" },
      { type: "msg", char: "asclepius", text: "どうすれば…！生き返ってくれ！" },
      { type: "narr", text: "そこに以前助けた一匹の蛇が、ある植物の葉を咥えて入ってきた。それを患者の口に入れると、患者は蘇生した" },
      { type: "msg", char: "student", text: "蛇が患者を助けたんですね！" },
      { type: "choice", text: "世界初の病院と呼ばれる施設は？", options: ["パンテオン", "アスクレピエイオン", "コロッセオ"], answer: 1 },
      { type: "highlight", text: "🐍 蛇は脱皮することから「再生」と「復活」の象徴とされ、アスクレピオスの杖に巻き付いている。" },
    ],
  },
  ...
  // ===== P.10 ヒッポリュトス =====
  {
    ...
    linkedStep: 4,
    messages: [
      { type: "narr", text: "アテナイの王テセウスの息子ヒッポリュトスは、継母パイドラからの恋心を拒絶した" },
      { type: "msg", char: "narrator", text: "ヒッポリュトスは激怒しパイドラを罵ります。" },
      { type: "msg", char: "narrator", text: "しかし、ショックを受けたパイドラは首を吊りました。" },
      { type: "msg", char: "narrator", text: "国外追放を命令し、さらには、海の神に息子の死を祈ります。" },
      { type: "msg", char: "narrator", text: "その結果、ヒッポリュトスは怪物の襲撃を受けて無実のまま命を落とした。" },
      { type: "choice", text: "なぜヒッポリュトスは命を落とした？", options: ["病気になった", "継母の遺書で父に誤解され呪われた", "戦争で戦死した"], answer: 1 },
      { type: "narr", text: "女神アルテミスの頼みで、アスクレピオスはこの若者の遺体の前に立った" },
      { type: "msg", char: "asclepius", text: "ゼウス様から死者の蘇生は禁止されている…やはり、医療人としての想いを断ち切れない！" },
      { type: "narr", text: "呪文を唱えながら胸に手を当てます。すると、三度目の呪文が終わらないうちに蘇生した" },
      { type: "highlight", text: "🐎 アスクレピオスはゼウスの禁忌を破り、無実の若者ヒッポリュトスを蘇らせてしまった。" },
      { type: "msg", char: "student", text: "クレタ島のエピメニデスが「クレタ人はみな嘘つきだ」と言ったというパラドックスのようですね…自己矛盾に陥っている。" },
      { type: "highlight", text: "❓ 「クレタ島人は皆嘘つきだ」とクレタ島人が言うと、その発言自体が嘘なのか本当なのか決定できず矛盾する。（エピメニデスのパラドックス）" },
    ],
  },
